...
const SubProjectPageContent = ({
  ...
  return (
    <div className="flex">
      ...
      <Link
        href="/project"
        className="fixed top-8 left-8 z-10 inline-flex items-center gap-2 px-5 py-2 bg-sat-school-secondary-yellow text-sat-school-dark-blue font-bold rounded-full shadow-lg hover:bg-sat-school-egg-yellow transition-colors shadow-md"
      >
        <svg
          width="20"
          height="20"
